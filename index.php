		...
		<div class="container">
			...
			<div class="col-lg-8 col-md-7">
				<div class="row">
					...
					<br>
					<p class="text-center"><span class="big">Download Cakebrew today and discover the wonderful world of Homebrew and its Formulas!</span><br>Current Version: 1.0.9 (August 1st, 2014)</p>
					<br>
					<p class="text-center">
