			...
			<div class="col-lg-8 col-md-7">
				<div class="row">
					...
					<p class="text-center btns-download">
						<a href="https://cdn.cakebrew.com/cakebrew-1.2.3.dmg" class="btn btn-lg btn-primary"><span class="glyphicon glyphicon-cloud-download"></span>Download Now <small>via KeyCDN</small></a>
